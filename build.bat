...
java -jar %YUI_COMPRESSOR_JAR% resources\css\common.css -o %BUILD_ROOT%\resources\css\common.css
java -jar %YUI_COMPRESSOR_JAR% resources\css\popup.css -o %BUILD_ROOT%\resources\css\popup.css
java -jar %YUI_COMPRESSOR_JAR% resources\css\tree.css -o %BUILD_ROOT%\resources\css\tree.css
java -jar %YUI_COMPRESSOR_JAR% resources\css\plot.css -o %BUILD_ROOT%\resources\css\plot.css

mkdir %BUILD_ROOT%\resources\javascript
java -jar %YUI_COMPRESSOR_JAR% resources\javascript\calculator.js -o %BUILD_ROOT%\resources\javascript\calculator.js
java -jar %YUI_COMPRESSOR_JAR% resources\javascript\popup.js -o %BUILD_ROOT%\resources\javascript\popup.js
java -jar %YUI_COMPRESSOR_JAR% resources\javascript\tree.js -o %BUILD_ROOT%\resources\javascript\tree.js
java -jar %YUI_COMPRESSOR_JAR% resources\javascript\plot.js -o %BUILD_ROOT%\resources\javascript\plot.js
